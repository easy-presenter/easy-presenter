...
class PresentationTrack
  ...
  remotePath: =>
    ...
    return "#{path}/00_teaser.md" # if directory
...
class @CwGithubLinkForSLide
  @appendGithubLinksToSLides: ->
    ...
    $.each slides, (index, slide) ->
      # https://github.com/easy-presentations/cw-wordpress-divi/blob/master/pages/de/00_index/00_teaser.md
      # https://raw.github/easy-presentations/cw-wordpress-divi/master/pages/de/00_index/00_teaser.md
